...
const Grid = () => {
  ...
  return (
    <div className="grid grid-cols-5 grid-rows-7 h-screen">
      ...
      <div className="segundo my-element col-span-3 row-span-4 col-start-3 border-right border-black border-l-4"></div>
      <div className="tercero my-element col-span-2 row-span-4 row-start-4 border-top border-black border-t-4"></div>
      <div className="cuarto my-element col-span-3 row-span-3 col-start-3 row-start-5 border-left border-top border-t-4 border-l-4 border-black"></div>
    </div>
  );
}
